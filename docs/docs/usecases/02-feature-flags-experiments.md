...
- итог эксперимента
- <exp:Метрика|Метрики> эксперимента ??? как выражены, где порог ???
...
1. Создание эксперимента с указанным названием, ключом флага, долей аудитории, 
    вариантами, таргетированием и метриками
2. Статус = Черновик, Версия = 1
